...
const gulp         = require('gulp'),                       // Сам сборщик Gulp
  ...
  sass2         = require('gulp-sass'),                  // Пакет компиляции SASS/SCSS
...
gulp.task('default', ['sass', 'sass2', 'img', 'pug', 'jsLibs', 'scripts', 'browser-sync'], () => {
// стили
gulp.watch([`${dev}/sass/style.sass`, `${dev}/sass/assets/*.sass`, `${dev}/sass/componets/*.sass`, `${dev}/libs/**/*.css`], ['sass']);
gulp.watch([`${dev}/sass/libs.sass`], ['sass2']);
// разметка
...
// Собираем наш билд
gulp.task('build', ['clean', 'img', '_sass', '_sass2', '_pug', 'jsLibs', '_scripts', 'service-worker'], () => {
